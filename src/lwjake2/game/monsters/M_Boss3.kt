...
public class M_Boss3 {
    companion object {
        ...
        var Use_Boss3: EntUseAdapter = object : EntUseAdapter() {
        ...
        var Think_Boss3Stand: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
     ...
     */
        public fun SP_monster_boss3_stand(self: edict_t) {
