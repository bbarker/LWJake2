...
public class GameAI {
    companion object {
        ...
        public fun AttackFinished(self: edict_t, time: Float) {
         ...
         */
        public fun ai_turn(self: edict_t, dist: Float) {
            if (dist != 0)
        ...
        public fun FacingIdeal(self: edict_t): Boolean {
            val delta: Float
         ...
         */
        public fun ai_run_melee(self: edict_t) {
         ...
         */
        public fun ai_run_missile(self: edict_t) {
            self.ideal_yaw = enemy_yaw
            M.M_ChangeYaw(self)
         ...
         */
        public fun ai_run_slide(self: edict_t, distance: Float) {
            val ofs: Float
         ...
         */
        public fun ai_checkattack(self: edict_t, dist: Float): Boolean {
            val temp = floatArray(0.0, 0.0, 0.0)

            var hesDeadJim: Boolean

            // this causes monsters to run blindly to the combat point w/o firing
            if (self.goalentity != null) {
                if ((self.monsterinfo.aiflags and Defines.AI_COMBAT_POINT) != 0)
                    return false

                if ((self.monsterinfo.aiflags and Defines.AI_SOUND_TARGET) != 0) {
                    if ((GameBase.level.time - self.enemy.teleport_time) > 5.0) {
                        ...
                        self.monsterinfo.aiflags = self.monsterinfo.aiflags and Defines.AI_SOUND_TARGET.inv()
                        if ((self.monsterinfo.aiflags and Defines.AI_TEMP_STAND_GROUND) != 0)
                            self.monsterinfo.aiflags = self.monsterinfo.aiflags and (Defines.AI_STAND_GROUND or Defines.AI_TEMP_STAND_GROUND).inv()
                    } else {
                        self.show_hostile = GameBase.level.time as Int + 1
                        return false
                    }
                }
            }
            ...
            if ((null == self.enemy) || (!self.enemy.inuse)) {
                hesDeadJim = true
            } else if ((self.monsterinfo.aiflags and Defines.AI_MEDIC) != 0) {
                if (self.enemy.health > 0) {
                    hesDeadJim = true
                    self.monsterinfo.aiflags = self.monsterinfo.aiflags and Defines.AI_MEDIC.inv()
                }
            } else {
                if ((self.monsterinfo.aiflags and Defines.AI_BRUTAL) != 0) {
            ...
            self.show_hostile = GameBase.level.time as Int + 1 // wake up other
         ...
         */
        fun ai_walk(self: edict_t, dist: Float) {
        ...
        fun AI_SetSightClient() {
            ...
            while (true) {
                ...
                if (ent.inuse && ent.health > 0 && (ent.flags and Defines.FL_NOTARGET) == 0) {
         ...
         */
        fun ai_move(self: edict_t, dist: Float) {
            M.M_walkmove(self, self.s.angles[Defines.YAW], dist)
        }
        ...
        fun HuntTarget(self: edict_t) {
            ...
            if (0 == (self.monsterinfo.aiflags and Defines.AI_STAND_GROUND))
                GameUtil.AttackFinished(self, 1)
        }


        public var walkmonster_start_go: EntThinkAdapter = object : EntThinkAdapter() {
            ...
            public fun think(self: edict_t): Boolean {
                ...
                if (0 == (self.spawnflags and 2) && GameBase.level.time < 1) {
        ...
        public var walkmonster_start: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
        ...
        public var flymonster_start_go: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
        ...
        public var flymonster_start: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
        ...
        public var swimmonster_start_go: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
        ...
        public var swimmonster_start: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
                return "swimmonster_start"
            }

            public fun think(self: edict_t): Boolean {
                self.flags = self.flags or Defines.FL_SWIM
         ...
         * adjustments needed by the animations
         */
        public var ai_turn: AIAdapter = object : AIAdapter() {
            public fun getID(): String {
                return "ai_turn"
            }

            public fun ai(self: edict_t, dist: Float) {
         ...
         * functions: ai_forward, ai_back, ai_pain, and ai_painforward
         */
        public var ai_move: AIAdapter = object : AIAdapter() {
            public fun getID(): String {
                return "ai_move"
            }
         ...
         * The monster is walking it's beat.
         */
        public var ai_walk: AIAdapter = object : AIAdapter() {
            public fun getID(): String {
                return "ai_walk"
            }
        ...
        public var ai_stand: AIAdapter = object : AIAdapter() {
            public fun getID(): String {
                return "ai_stand"
            }
            ...
            public fun ai(self: edict_t, dist: Float) {
                ...
                if ((self.monsterinfo.aiflags and Defines.AI_STAND_GROUND) != 0) {
                    if (self.enemy != null) {
                        ...
                        if (self.s.angles[Defines.YAW] != self.ideal_yaw && 0 != (self.monsterinfo.aiflags and Defines.AI_TEMP_STAND_GROUND)) {
                            self.monsterinfo.aiflags = self.monsterinfo.aiflags and (Defines.AI_STAND_GROUND or Defines.AI_TEMP_STAND_GROUND).inv()
                            self.monsterinfo.run.think(self)
                        }
                        M.M_ChangeYaw(self)
                ...
                if (0 == (self.spawnflags and 1) && (self.monsterinfo.idle != null) && (GameBase.level.time > self.monsterinfo.idle_time)) {
                    if (self.monsterinfo.idle_time != 0) {
         ...
         * replace ai_face.
         */
        public var ai_charge: AIAdapter = object : AIAdapter() {
            public fun getID(): String {
                return "ai_charge"
            }
         ...
         */
        public var ai_run: AIAdapter = object : AIAdapter() {
            public fun getID(): String {
                return "ai_run"
            }
            ...
            public fun ai(self: edict_t?, dist: Float) {
                ...
                val d2: Float
                var tr: trace_t // mem
                val v_forward = floatArray(0.0, 0.0, 0.0)
                val v_right = floatArray(0.0, 0.0, 0.0)
                val left: Float
                var center: Float
                val right: Float
                val left_target = floatArray(0.0, 0.0, 0.0)
                val right_target = floatArray(0.0, 0.0, 0.0)
                ...
                if (0 == (self!!.monsterinfo.aiflags and Defines.AI_LOST_SIGHT)) {
                    // just lost sight of the player, decide where to go first
                    // dprint("lost sight of player, last seen at ");
                    // dprint(vtos(self.last_sighting));
                    // dprint("\n");
                    self!!.monsterinfo.aiflags = self!!.monsterinfo.aiflags or (Defines.AI_LOST_SIGHT or Defines.AI_PURSUIT_LAST_SEEN)
                    self!!.monsterinfo.aiflags = self!!.monsterinfo.aiflags and (Defines.AI_PURSUE_NEXT or Defines.AI_PURSUE_TEMP).inv()
                    new1 = true
                }

                if ((self!!.monsterinfo.aiflags and Defines.AI_PURSUE_NEXT) != 0) {
                    self!!.monsterinfo.aiflags = self!!.monsterinfo.aiflags and Defines.AI_PURSUE_NEXT.inv()
                    ...
                    if ((self!!.monsterinfo.aiflags and Defines.AI_PURSUE_TEMP) != 0) {
                        // dprint("was temp goal; retrying original\n");
                        self!!.monsterinfo.aiflags = self!!.monsterinfo.aiflags and Defines.AI_PURSUE_TEMP.inv()
                        marker = null
                        Math3D.VectorCopy(self!!.monsterinfo.saved_goal, self!!.monsterinfo.last_sighting)
                        new1 = true
                    } else if ((self!!.monsterinfo.aiflags and Defines.AI_PURSUIT_LAST_SEEN) != 0) {
                        self!!.monsterinfo.aiflags = self!!.monsterinfo.aiflags and Defines.AI_PURSUIT_LAST_SEEN.inv()
                ...
                if (d1 <= dist) {
                    self!!.monsterinfo.aiflags = self!!.monsterinfo.aiflags or Defines.AI_PURSUE_NEXT
                    dist = d1
                }
                ...
                if (new1) {
                    ...
                    if (tr.fraction < 1) {
                        ...
                        if (left >= center && left > right) {
                            if (left < 1) {
                                Math3D.VectorSet(v, d2 * left * 0.5.toFloat(), -16.toFloat(), 0.toFloat())
                                Math3D.G_ProjectSource(self!!.s.origin, v, v_forward, v_right, left_target)
                                // gi.dprintf("incomplete path, go part way and adjust again\n");
                            }
                            Math3D.VectorCopy(self!!.monsterinfo.last_sighting, self!!.monsterinfo.saved_goal)
                            self!!.monsterinfo.aiflags = self!!.monsterinfo.aiflags or Defines.AI_PURSUE_TEMP
                            ...
                            if (right < 1) {
                                Math3D.VectorSet(v, d2 * right * 0.5.toFloat(), 16.toFloat(), 0.toFloat())
                                Math3D.G_ProjectSource(self!!.s.origin, v, v_forward, v_right, right_target)
                                // gi.dprintf("incomplete path, go part way and adjust again\n");
                            }
                            Math3D.VectorCopy(self!!.monsterinfo.last_sighting, self!!.monsterinfo.saved_goal)
        ...
        var enemy_vis: Boolean = false

        var enemy_infront: Boolean = false

        var enemy_range: Int = 0

        var enemy_yaw: Float = 0.toFloat()
    }
}
