...
public class GameTarget {
    companion object {
        ...
        public fun SP_target_temp_entity(ent: edict_t) {
            ent.use = Use_Target_Tent
        }

        public fun SP_target_speaker(ent: edict_t) {
            ...
            if (ent.volume == 0)
                ent.volume = 1.0.toFloat()

            if (ent.attenuation == 0)
                ent.attenuation = 1.0.toFloat()
         ...
         */
        public fun SP_target_help(ent: edict_t) {
        ...
        public fun SP_target_secret(ent: edict_t) {
            if (GameBase.deathmatch.value != 0) {
                // auto-remove for deathmatch
                GameUtil.G_FreeEdict(ent)
                return
        ...
        public fun SP_target_goal(ent: edict_t) {
            if (GameBase.deathmatch.value != 0) {
                // auto-remove for deathmatch
                GameUtil.G_FreeEdict(ent)
                return
        ...
        public fun SP_target_explosion(ent: edict_t) {
            ent.use = use_target_explosion
            ent.svflags = Defines.SVF_NOCLIENT
        }

        public fun SP_target_changelevel(ent: edict_t) {
            if (ent.map == null) {
        ...
        public fun SP_target_splash(self: edict_t) {
        ...
        public fun SP_target_spawner(self: edict_t) {
        ...
        public fun SP_target_blaster(self: edict_t) {
        ...
        public fun SP_target_crosslevel_trigger(self: edict_t) {
            self.svflags = Defines.SVF_NOCLIENT
            self.use = trigger_crosslevel_trigger_use
        }

        public fun SP_target_crosslevel_target(self: edict_t) {
            if (0 == self.delay)
                self.delay = 1
            self.svflags = Defines.SVF_NOCLIENT
        ...
        public fun SP_target_earthquake(self: edict_t) {
         ...
         */
        public var Use_Target_Tent: EntUseAdapter = object : EntUseAdapter() {
         ...
         */
        public var Use_Target_Speaker: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
            ...
            public fun use(ent: edict_t, other: edict_t, activator: edict_t) {
                ...
                if ((ent.spawnflags and 3) != 0) {
                    ...
                    if ((ent.spawnflags and 4) != 0)
                        chan = Defines.CHAN_VOICE or Defines.CHAN_RELIABLE
                    else
        ...
        public var Use_Target_Help: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
         ...
         */
        var use_target_secret: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
         ...
         * These are single use targets.
         */
        var use_target_goal: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
         ...
         */
        var target_explosion_explode: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
        ...
        var use_target_explosion: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
         ...
         * "map" when fired
         */
        var use_target_changelevel: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
            ...
            public fun use(self: edict_t, other: edict_t, activator: edict_t?) {
                ...
                if (GameBase.deathmatch.value != 0 && 0 == (GameBase.dmflags.value as Int and Defines.DF_ALLOW_EXIT) && other != GameBase.g_edicts[0] /* world */) {
                ...
                if (self.map.indexOf('*') > -1)
                    GameBase.game.serverflags = GameBase.game.serverflags and (Defines.SFL_CROSS_TRIGGER_MASK).inv()
         ...
         */
        var use_target_splash: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
        ...
        var use_target_spawner: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
         ...
         */
        public var use_target_blaster: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
			...
			*/
                ...
                GameWeapon.fire_blaster(self, self.s.origin, self.movedir, self.dmg, self.speed as Int, Defines.EF_BLASTER, Defines.MOD_TARGET_BLASTER != 0)/* true */
         ...
         */
        public var trigger_crosslevel_trigger_use: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
                return "trigger_crosslevel_trigger_use"
            }

            public fun use(self: edict_t, other: edict_t, activator: edict_t) {
                GameBase.game.serverflags = GameBase.game.serverflags or self.spawnflags
                GameUtil.G_FreeEdict(self)
            }
        }
         ...
         * (default 1)
         */
        var target_crosslevel_target_think: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
                return "target_crosslevel_target_think"
            }

            public fun think(self: edict_t): Boolean {
                if (self.spawnflags == (GameBase.game.serverflags and Defines.SFL_CROSS_TRIGGER_MASK and self.spawnflags)) {
         ...
         */
        public var target_laser_think: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
            ...
            public fun think(self: edict_t): Boolean {
                ...
                val last_movedir = floatArray(0.0, 0.0, 0.0)
                val count: Int

                if ((self.spawnflags and -2147483648) != 0)
                    count = 8
                else
                    count = 4
                ...
                if (self.enemy != null) {
                    ...
                    Math3D.VectorMA(self.enemy.absmin, 0.5.toFloat(), self.enemy.size, point)
                    ...
                    if (!Math3D.VectorEquals(self.movedir, last_movedir))
                        self.spawnflags = self.spawnflags or -2147483648
                }
                ...
                while (true) {
                    ...
                    // hurt it if we can
                    if ((tr.ent.takedamage != 0) && 0 == (tr.ent.flags and Defines.FL_IMMUNE_LASER))
                    ...
                    if (0 == (tr.ent.svflags and Defines.SVF_MONSTER) && (null == tr.ent.client)) {
                        if ((self.spawnflags and -2147483648) != 0) {
                            self.spawnflags = self.spawnflags and -2147483648.inv()
                            GameBase.gi.WriteByte(Defines.svc_temp_entity)
        ...
        public var target_laser_use: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
        ...
        var target_laser_start: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
            ...
            public fun think(self: edict_t): Boolean {
                ...
                else if ((self.spawnflags and 16) != 0)
                    self.s.skinnum = -589439265
                else if ((self.spawnflags and 32) != 0)
                    self.s.skinnum = -522067229

                if (null == self.enemy) {
                    if (self.target != null) {
                        val edit = GameBase.G_Find(null, GameBase.findByTarget, self.target)
                        if (edit == null)
        ...
        var target_lightramp_think: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
            ...
            public fun think(self: edict_t): Boolean {
                ...
                val tmp = charArray(('a' + (self.movedir[0] + (GameBase.level.time - self.timestamp) / Defines.FRAMETIME * self.movedir[2]) as Int).toChar())

                GameBase.gi.configstring(Defines.CS_LIGHTS + self.enemy.style, String(tmp))

                if ((GameBase.level.time - self.timestamp) < self.speed) {
                    self.nextthink = GameBase.level.time + Defines.FRAMETIME
                } else if ((self.spawnflags and 1) != 0) {
                    val temp: Char

                    temp = self.movedir[0] as Char
        ...
        var target_lightramp_use: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
        ...
        var target_earthquake_think: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
            ...
            public fun think(self: edict_t): Boolean {
                ...
                if (self.last_move_time < GameBase.level.time) {
                    GameBase.gi.positioned_sound(self.s.origin, self, Defines.CHAN_AUTO, self.noise_index, 1.0.toFloat(), Defines.ATTN_NONE, 0)
                    self.last_move_time = GameBase.level.time + 0.5.toFloat()
                }
                ...
                run {
                    ...
                    while (i < GameBase.num_edicts) {
                        ...
                        e.velocity[2] = self.speed * (100.0.toFloat() / e.mass)
                        i++
                    }
                }
        ...
        var target_earthquake_use: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
