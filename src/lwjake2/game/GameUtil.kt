...
public class GameUtil {
    companion object {
        ...
        public fun checkClassname(ent: edict_t) {
        ...
        public fun G_UseTargets(ent: edict_t, activator: edict_t?) {
            val t: edict_t
            ...
            // print the message
            if ((ent.message != null) && (activator!!.svflags and Defines.SVF_MONSTER) == 0) {
        ...
        public fun G_InitEdict(e: edict_t, i: Int) {
            e.inuse = true
            e.classname = "noclass"
            e.gravity = 1.0.toFloat()
            //e.s.number= e - g_edicts;
            e.s = entity_state_t(e)
            e.s.number = i
            e.index = i
        }
         ...
         */
        public fun G_Spawn(): edict_t {
            var i: Int
            var e: edict_t? = null

            run {
                i = GameBase.maxclients.value as Int + 1
                while (i < GameBase.num_edicts) {
                    ...
                    if (!e!!.inuse && (e!!.freetime < 2 || GameBase.level.time - e!!.freetime > 0.5)) {
                        e = GameBase.g_edicts[i] = edict_t(i)
                        G_InitEdict(e, i)
                        return e
                    }
                    i++
         ...
         */
        public fun G_FreeEdict(ed: edict_t) {
            ...
            GameBase.g_edicts[ed.index] = edict_t(ed.index)
            ed.classname = "freed"
        ...
        public fun G_ClearEdict(ent: edict_t) {
            val i = ent.index
            GameBase.g_edicts[i] = edict_t(i)
        }
        ...
        public fun KillBox(ent: edict_t): Boolean {
            val tr: trace_t
         ...
         */
        public fun OnSameTeam(ent1: edict_t, ent2: edict_t): Boolean {
         ...
         */
        fun ClientTeam(ent: edict_t): String {
            val value: String
            ...
            if (((GameBase.dmflags.value) as Int and Defines.DF_MODELTEAMS) != 0) {
        ...
        fun ValidateSelectedItem(ent: edict_t) {
            val cl: gclient_t
         ...
         * triggered by damage.
         */
        public fun range(self: edict_t, other: edict_t): Int {
        ...
        fun AttackFinished(self: edict_t, time: Float) {
         ...
         */
        public fun infront(self: edict_t, other: edict_t): Boolean {
         ...
         */
        public fun visible(self: edict_t, other: edict_t): Boolean {
         ...
         */
        fun FindTarget(self: edict_t): Boolean {
            val client: edict_t?
            var heardit: Boolean
            val r: Int

            if ((self.monsterinfo.aiflags and Defines.AI_GOOD_GUY) != 0) {
            ...
            heardit = false
            if ((GameBase.level.sight_entity_framenum >= (GameBase.level.framenum - 1)) && 0 == (self.spawnflags and 1)) {
                ...
                heardit = true
            } else if (null != (self.enemy) && (GameBase.level.sound2_entity_framenum >= (GameBase.level.framenum - 1)) && 0 != (self.spawnflags and 1)) {
            ...
            if (client!!.client != null) {
                if ((client!!.flags and Defines.FL_NOTARGET) != 0)
                    return false
            } else if ((client!!.svflags and Defines.SVF_MONSTER) != 0) {
                if (client!!.enemy == null)
                    return false
                if ((client!!.enemy.flags and Defines.FL_NOTARGET) != 0)
                    return false
            } else if (heardit) {
                if ((client!!.owner.flags and Defines.FL_NOTARGET) != 0)
                    return false
            } else
                return false
            ...
            if (!heardit) {
                ...
                self.monsterinfo.aiflags = self.monsterinfo.aiflags or Defines.AI_SOUND_TARGET
            ...
            if (0 == (self.monsterinfo.aiflags and Defines.AI_SOUND_TARGET) && (self.monsterinfo.sight != null))
                self.monsterinfo.sight.interact(self, self.enemy)

            return true
        }

        public fun FoundTarget(self: edict_t) {
            ...
            self.monsterinfo.aiflags = self.monsterinfo.aiflags or Defines.AI_COMBAT_POINT
        ...
        public var Think_Delay: EntThinkAdapter = object : EntThinkAdapter() {
        ...
        public var G_FreeEdictA: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
                return "G_FreeEdictA"
            }
        ...
        var MegaHealth_think: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
            ...
            public fun think(self: edict_t): Boolean {
                ...
                if (!((self.spawnflags and Defines.DROPPED_ITEM) != 0) && (GameBase.deathmatch.value != 0))
        ...
        public var M_CheckAttack: EntThinkAdapter = object : EntThinkAdapter() {
            public fun getID(): String {
            ...
            public fun think(self: edict_t): Boolean {
                ...
                if (self.enemy.health > 0) {
                    ...
                    tr = GameBase.gi.trace(spot1, null, null, spot2, self, Defines.CONTENTS_SOLID or Defines.CONTENTS_MONSTER or Defines.CONTENTS_SLIME or Defines.CONTENTS_LAVA or Defines.CONTENTS_WINDOW)
                ...
                if (GameAI.enemy_range == Defines.RANGE_MELEE) {
                    ...
                    if (GameBase.skill.value == 0 && (Lib.rand() and 3) != 0)
                        return false
        ...
        var monster_use: EntUseAdapter = object : EntUseAdapter() {
            public fun getID(): String {
                return "monster_use"
            }
            ...
            public fun use(self: edict_t, other: edict_t, activator: edict_t) {
                ...
                if (self.health <= 0)
                    return
                if ((activator.flags and Defines.FL_NOTARGET) != 0)
                    return
                if ((null == activator.client) && 0 == (activator.monsterinfo.aiflags and Defines.AI_GOOD_GUY))
                    return
